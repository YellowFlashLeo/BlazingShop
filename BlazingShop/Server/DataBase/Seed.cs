...
namespace BlazingShop.Server.DataBase
{
    public class Seed
    {
        ...
        {
            if (!userManager.Users.Any() && !context.Categories.Any()
                                         && !context.ProductTypes.Any()
                                         && !context.Products.Any()
                                         && !context.Stats.Any()
                                         && !context.ProductVariants.Any())
            {
                var users = new List<User>
                {
                    new User
                    {
                        FirstName = "Leonid", LastName = "Lobanov", EmailAddress = "leonid.lobanov@mail.ru",
                        Password = "leonid199730"
                    }
                };
                ...
                var products = new List<Product>
                {
                    ...
                    new Product
                    {
                        ...
                        ImageUrl = "/Images/BackToTheFuture.jpg",
                        Featured = true
                    },
                    new Product
                    {
                    ...
                    new Product
                    {
                        ...
                        ImageUrl = "/Images/Xbox-console.jpg"
                    },
                    new Product
                    {
                        Id = 11,
                ...
                {
                    new Stats {Visits = 1, LastVisit = DateTime.Today}
                };
